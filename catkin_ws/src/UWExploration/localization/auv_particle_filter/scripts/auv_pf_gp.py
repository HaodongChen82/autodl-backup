...
class auv_pf(object):
    ...
    def __init__(self):
        ...
        try:
            ...
            # Set default transforms to avoid AttributeError
            self.m2o_mat = np.eye(4)  # Identity matrix for map to odom
            self.base2mbes_mat = np.eye(4)  # Identity matrix for base to mbes
