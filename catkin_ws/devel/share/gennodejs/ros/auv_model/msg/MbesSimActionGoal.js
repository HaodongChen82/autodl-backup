...
class MbesSimActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MbesSimGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += MbesSimGoal.getMessageSize(object.goal);
    return length;
  }

  static datatype() {
    // Returns string type for a message object
    return 'auv_model/MbesSimActionGoal';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'a3782d90fc3444e2086bc2d40775e61a';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MbesSimActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = MbesSimGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new MbesSimGoal()
    }
...
module.exports = MbesSimActionGoal;
