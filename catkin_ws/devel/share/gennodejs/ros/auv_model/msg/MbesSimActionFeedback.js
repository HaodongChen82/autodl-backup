...
class MbesSimActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new MbesSimFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MbesSimFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MbesSimActionFeedback(null);
    ...
    data.feedback = MbesSimFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'auv_model/MbesSimActionFeedback';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MbesSimActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = MbesSimFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new MbesSimFeedback()
    }
...
module.exports = MbesSimActionFeedback;
